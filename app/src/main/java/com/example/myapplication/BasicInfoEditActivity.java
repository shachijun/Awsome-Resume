...
//public class BasicInfoEditActivity extends BasicInfoChange<BasicInfo> {
//
...
//        return R.layout.activity_basicinfo_edit;
//    }
//    @Override
...
//        data.photo = (Uri) findViewById(R.id.basic_info_edit_image).getTag();
//
